...
public class TargetController implements IGTVGController {
    ...
    public void process(
    	...
    	final Vendor vendor = vendorService.findById(5);
        
        final WebContext ctx = new WebContext(request, response, servletContext, request.getLocale());
        ctx.setVariable("target", vendor);
        
        templateEngine.process("vendor/target", ctx, response.getWriter());
