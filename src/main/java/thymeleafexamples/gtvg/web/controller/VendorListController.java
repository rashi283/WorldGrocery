...
public class VendorListController implements IGTVGController {
    ...
    public void process(
        ...
        final List<Vendor> allVendors = vendorService.findAll(); 
        
        final WebContext ctx = new WebContext(request, response, servletContext, request.getLocale());
        ctx.setVariable("vends", allVendors);
        
        templateEngine.process("vendor/list", ctx, response.getWriter());
